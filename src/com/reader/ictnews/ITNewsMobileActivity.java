...
public class ITNewsMobileActivity extends Activity{

	private ITNewsMobileActivity local;
	 ...
	 @Override
	    public void onCreate(Bundle savedInstanceState) {
	        ...
	        task.execute("http://www.itvesti.info/feeds/posts/default/-/Mobilni?alt=rss");
