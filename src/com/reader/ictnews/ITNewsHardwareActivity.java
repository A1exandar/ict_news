...
public class ITNewsHardwareActivity extends Activity {
	
	 private ITNewsHardwareActivity local;
	 ...
	 @Override
	    public void onCreate(Bundle savedInstanceState) {
	        ...
	        task.execute("http://www.itvesti.info/feeds/posts/default/-/Hardver?alt=rss");
